...
class image_loader():
    ...
    def __init__(self, parent_folder_path, folder_list = None,split = [0.8,0.1,0.1] ):
        ...
        size_train_val_test = size_train_val + self.size['test']
        ...
        self.dir_image_paths['test'] = [self.image_paths[i] for i in index[size_train_val:size_train_val_test] ]
        ...
        self.dir_image_labels['test'] = [self.image_labels[i] for i in index[size_train_val:size_train_val_test] ]
